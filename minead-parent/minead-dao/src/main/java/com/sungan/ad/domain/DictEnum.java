...
public enum DictEnum {
	...
	ADAPPTASKSTAUS(DictEnum.ADAPPTASKSTAUS_KEY,new DictItem[]{new DictItem(AppTask.APPTASK_STATUS_NOTPUBLIC,"未发布"),new DictItem(AppTask.APPTASK_STATUS_PUBLIC,"已发布"),new DictItem(AppTask.APPTASK_STATUS_RUNNING,"运行中"),new DictItem(AppTask.APPTASK_STATUS_SUCCESS,"任务完成"),new DictItem(AppTask.APPTASK_STATUS_FAIL,"任务失败"),new DictItem(AppTask.APPTASK_STATUS_INVALID,"任务失效")},"client运行任务状态");
	...
	public static final String ADAPPTASKSTAUS_KEY = "000103";   //权重组是否是默认
